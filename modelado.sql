-- DDL --
-- crear esquema --
create schema modelado_maria_ojie authorization zprrluvm;

-- crear tablas --

-- tabla coches --

create table modelado_maria_ojie.coches(
...
alter table modelado_maria_ojie.revisiones
...
references modelado_maria_ojie.colores (id_color);

alter table modelado_maria_ojie.coches
add constraint modelo_coche_kf foreign key (id_modelo)
references modelado_maria_ojie.modelos (id_modelo);

alter table modelado_maria_ojie.coches
add constraint marca_coche_kf foreign key (id_marca)
references modelado_maria_ojie.marcas (id_marca);

alter table modelado_maria_ojie.coches
add constraint grupo_marca_coche_kf foreign key (id_grupo_marca)
references modelado_maria_ojie.grupoMarca (id_grupo_marca);

alter table modelado_maria_ojie.coches
add constraint aseguradora_coche_kf foreign key (id_aseguradora)
references modelado_maria_ojie.aseguradoras (id_aseguradora);
...
references modelado_maria_ojie.coches (id_coche);
...
references modelado_maria_ojie.monedas (id_moneda);
...
insert into modelado_maria_ojie.monedas 
(id_moneda, moneda)
values('001', 'euro');
...
insert into modelado_maria_ojie.colores  
(id_color, color)
values('001', 'Rojo');
...
insert into modelado_maria_ojie.grupomarca  
...
insert into modelado_maria_ojie.marcas  
...
--  modelos --
insert into modelado_maria_ojie.modelos  
...
--  aseguradoras --
insert into modelado_maria_ojie.aseguradoras  
...
-- coches --
insert into modelado_maria_ojie.coches 
...
insert into modelado_maria_ojie.seguros  
...
insert into modelado_maria_ojie.revisiones  
